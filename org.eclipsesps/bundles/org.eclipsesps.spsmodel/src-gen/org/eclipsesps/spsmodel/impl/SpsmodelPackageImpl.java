...
public class SpsmodelPackageImpl extends EPackageImpl implements SpsmodelPackage {
	...
	public void initializePackageContents() {
		...
		ETypeParameter abstractWriteableIOFieldEClass_T = addETypeParameter(abstractWriteableIOFieldEClass, "T");
		...
		initEClass(iioFieldEClass, IIOField.class, "IIOField", IS_ABSTRACT, IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEOperation(getIIOField__GetId(), ecorePackage.getEString(), "getId", 0, 1, IS_UNIQUE, IS_ORDERED);

		EOperation op = initEOperation(getIIOField__GetValue(), null, "getValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(iioFieldEClass_T);
		initEOperation(op, g1);

		initEClass(writeableIOFieldEClass, WriteableIOField.class, "WriteableIOField", IS_ABSTRACT, IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		op = initEOperation(getWriteableIOField__WriteValue__Object(), null, "writeValue", 0, 1, IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(writeableIOFieldEClass_T);
		addEParameter(op, g1, "value", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getWriteableIOField__WriteValueSync__Object(), null, "writeValueSync", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		g1 = createEGenericType(writeableIOFieldEClass_T);
		addEParameter(op, g1, "value", 0, 1, IS_UNIQUE, IS_ORDERED);

		initEClass(abstractIOFieldEClass, AbstractIOField.class, "AbstractIOField", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAbstractIOField_Id(), ecorePackage.getEString(), "id", null, 0, 1, AbstractIOField.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		g1 = createEGenericType(abstractIOFieldEClass_T);
		initEAttribute(getAbstractIOField_Value(), g1, "value", null, 0, 1, AbstractIOField.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(abstractWriteableIOFieldEClass, AbstractWriteableIOField.class, "AbstractWriteableIOField",
		...
		initEClass(digitalOutputEClass, DigitalOutput.class, "DigitalOutput", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
