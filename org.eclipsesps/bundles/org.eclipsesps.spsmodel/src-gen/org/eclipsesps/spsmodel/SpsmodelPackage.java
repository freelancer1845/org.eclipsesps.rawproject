...
public interface SpsmodelPackage extends EPackage {
   ...
   * @ordered
   */
  int ABSTRACT_WRITEABLE_IO_FIELD___WRITE_VALUE_SYNC__OBJECT =
      ABSTRACT_IO_FIELD_OPERATION_COUNT + 1;
   ...
   * @ordered
   */
  int ANALOG_OUTPUT___WRITE_VALUE_SYNC__OBJECT =
      ABSTRACT_WRITEABLE_IO_FIELD___WRITE_VALUE_SYNC__OBJECT;
   ...
   * @ordered
   */
  int DIGITAL_OUTPUT___WRITE_VALUE_SYNC__OBJECT =
      ABSTRACT_WRITEABLE_IO_FIELD___WRITE_VALUE_SYNC__OBJECT;
  ...
  interface Literals {
     ...
     * <!-- end-user-doc -->
    	 * @generated
    	 */
    EOperation WRITEABLE_IO_FIELD___WRITE_VALUE__OBJECT =
        eINSTANCE.getWriteableIOField__WriteValue__Object();
     ...
     * <!-- end-user-doc -->
    	 * @generated
    	 */
    EOperation WRITEABLE_IO_FIELD___WRITE_VALUE_SYNC__OBJECT =
        eINSTANCE.getWriteableIOField__WriteValueSync__Object();
